...
describe('pending_operations operation_type CHECK audit', () => {
  ...
  it('extraction still matches the staging call sites', () => {
    ...
    // 42 call sites / 42 distinct types as of 2026-08-09, after the fork
    // dropped payroll, transaction and integration tools and frihetspaketet
    // added delete_voucher / edit_posted_entry / delete_document. The floor is
    // a canary: a big drop means the regex no longer matches the code shape,
