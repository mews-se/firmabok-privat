...
**Software implication**: your system should support read-only access for Skatteverket during revision. Accounted's immutable `audit_log` and full row-level audit trail naturally support this. Consider building a dedicated API endpoint or export mechanism.
