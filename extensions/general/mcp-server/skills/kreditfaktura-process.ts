...
- **BFL 5 kap. 6-7 §**: a sent invoice is corrected with a kreditfaktura, never by editing the invoice. (On the journal side, this installation allows in-place edits and deletes of posted entries and journal gaps are allowed; the invoice löpnummer series stays gap-free regardless.)
